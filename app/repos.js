...
var Repo = React.createClass({
  ...
  render: function() {
    return <li><a href={this.props.data.url}>{decodeURIComponent(this.props.name)}</a></li>;
  },
})
...
var RepoList = React.createClass({
  ...
  componentWillMount: function() {
    var firebaseRef = new Firebase("https://debt.firebaseio.com").child(this.state.repotype);
